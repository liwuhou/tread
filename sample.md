...
这是一篇用于测试 **tread** 终端阅读器的长文档。内容涵盖了所有章节类型和排版元素，足够长以验证滚动、翻页、跳转等功能。
...
tread 的目标是成为终端里的 "Kindle"——一个让你可以舒适地阅读各种格式文档的工具。
...
tread 采用了广受欢迎的 Vim 风格快捷键。以下是最常用的快捷键一览：
...
*感谢你读到这里！这份文档的目的是充分测试 tread 的各项功能。*
